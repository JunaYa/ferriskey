export namespace Schemas {
  ...
  export type CreatePromptResponse = { data: Prompt };
  export type CreatePromptValidator = { description: string; name: string; template: string; version: string };
  ...
  export type DeletePromptResponse = { message: string };
  ...
  export type GetPromptsResponse = { data: Array<Prompt> };
  ...
  export type UpdatePromptResponse = { data: Prompt };
  export type UpdatePromptValidator = Partial<{
    description: string | null;
...
export namespace Endpoints {
  ...
  export type post_Create_prompt = {
    method: 'POST';
    path: '/realms/{realm_name}/prompts';
    requestFormat: 'json';
    parameters: {
      ...
      body: Schemas.CreatePromptValidator;
    };
    response: Schemas.CreatePromptResponse;
  };
  export type get_Get_prompt = {
    method: 'GET';
    path: '/realms/{realm_name}/prompts/{prompt_id}';
    requestFormat: 'json';
    parameters: {
      path: { realm_name: string; prompt_id: string };
    };
    response: Schemas.Prompt;
  };
  export type put_Update_prompt = {
    method: 'PUT';
    path: '/realms/{realm_name}/prompts/{prompt_id}';
    requestFormat: 'json';
    parameters: {
      ...
      body: Schemas.UpdatePromptValidator;
    };
    response: Schemas.UpdatePromptResponse;
  };
  export type delete_Delete_prompt = {
    method: 'DELETE';
    path: '/realms/{realm_name}/prompts/{prompt_id}';
    requestFormat: 'json';
    parameters: {
    ...
    response: Schemas.DeletePromptResponse;
  };
...
export type EndpointByMethod = {
  post: {
    ...
    '/realms/{realm_name}/prompts': Endpoints.post_Create_prompt;
  ...
  put: {
    ...
    '/realms/{realm_name}/prompts/{prompt_id}': Endpoints.put_Update_prompt;
